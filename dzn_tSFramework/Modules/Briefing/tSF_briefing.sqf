...
TOPIC("I. Обстановка:")
"После эскалациии конфликта прошло 2 года и наш контингет вырос с 200 чел. до 16 тысяч
<br />Коммунисты наращивают свое влияние и контроль над территориями, и подошли вплотную к границе Лаоса.
<br />
<br />Неделю назад наш FOB на востоке был атакован и захвачен силами Вьет Конга, информаторы сообщают что часть находящегося там взвода выжили и попали в плен. Скорее всего их будут транспортировать глубже на север, на подконтрольные коммунистам территории. По данным информаторов, они все еще могут находиться в районе POW Camp
<br />Если мы не спасем пленных в ближайшее время, то вероятнее всего спасти их в после транспортировки вглубь вржеских територий, не представится возможным.
<br />
...
"По плану командира.
<br />
<br />Для первого прохождения реккоммендуется:
