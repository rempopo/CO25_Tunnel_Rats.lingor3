...
TOPIC("I. Обстановка:")
"Неделю назад наш FOB на востоке был атакован и захвачен силами Вьетконга, информаторы сообщают что часть находящегося там взвода выжили и попали в плен. Скорее всего их будут транспортировать на север, вглубь территорий подконтрольных врагу. Мы предполагаем, что на данный момент их содержат в POW Camp. Один из наших информаторов находится в этом лагере, и может обладать более подробной информацией об их судьбах.
<br />Если мы не спасем пленных в ближайшее время, то вероятнее всего спасти их больше не удастся.
<br />
<br />Скауты готовы развернуть CCP в районе Echo, Eddie или Zanjeer
<br />В случае необходимости вам могут быть переданы M113 на Echo
<br />
<br />Нашим информатором в POW Camp является офицер NVA, у его казармы установлен красный флагшток.
<br />"
END
